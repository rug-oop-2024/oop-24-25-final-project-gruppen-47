...
from app.core.modelling.datasets import artifact_to_dataset, pick_dataset, select_features
...
predictions_csv = st.file_uploader("**Upload a CSV file for predictions:**", type="csv")
...
if st.button("Deploy"):
    ...
    st.write("Refresh the page to view the updated list of deployed pipelines.")
    st.balloons()